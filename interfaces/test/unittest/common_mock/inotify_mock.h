...
#ifndef INTERFACES_TEST_UNITTEST_COMMON_MOCK_INOTIFY_MOCK_H
#define INTERFACES_TEST_UNITTEST_COMMON_MOCK_INOTIFY_MOCK_H
...
#endif // INTERFACES_TEST_UNITTEST_COMMON_MOCK_INOTIFY_MOCK_H