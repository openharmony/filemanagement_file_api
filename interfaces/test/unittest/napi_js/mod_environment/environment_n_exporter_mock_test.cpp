...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetExternalStorageDir_001
 * @tc.desc: Test function of GetExternalStorageDir interface for FAILURE when GetParameter fails.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetExternalStorageDir_002
 * @tc.desc: Test function of GetExternalStorageDir interface for FAILURE when is not system app.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetExternalStorageDir_003
 * @tc.desc: Test function of GetExternalStorageDir interface for FAILURE when VerifyAccessToken fails.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetUserHomeDir_001
 * @tc.desc: Test function of GetUserHomeDir interface for FAILURE when GetParameter fails.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetUserHomeDir_002
 * @tc.desc: Test function of GetUserHomeDir interface for FAILURE when is not system app.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: EnvironmentNExporterMockTest_GetUserHomeDir_003
 * @tc.desc: Test function of GetUserHomeDir interface for FAILURE when VerifyAccessToken fails.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
         ...
         testing::ext::TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "EnvironmentNExporterMockTest-end EnvironmentNExporterMockTest_GetUserDesktopDir_002";
}
         ...
         testing::ext::TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "EnvironmentNExporterMockTest-end EnvironmentNExporterMockTest_GetUserDocumentDir_002";
}
         ...
         testing::ext::TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "EnvironmentNExporterMockTest-end EnvironmentNExporterMockTest_GetExternalStorageDir_004";
}
         ...
         testing::ext::TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "EnvironmentNExporterMockTest-end EnvironmentNExporterMockTest_GetUserHomeDir_004";
}
