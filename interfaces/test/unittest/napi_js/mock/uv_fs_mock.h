...
#ifndef INTERFACES_TEST_UNITTEST_NAPI_JS_MOCK_UV_FS_MOCK_H
#define INTERFACES_TEST_UNITTEST_NAPI_JS_MOCK_UV_FS_MOCK_H
...
#endif // INTERFACES_TEST_UNITTEST_NAPI_JS_MOCK_UV_FS_MOCK_H