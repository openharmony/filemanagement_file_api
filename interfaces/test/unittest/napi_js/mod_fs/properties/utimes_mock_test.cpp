...
/**
 * @tc.name: UtimesSync_0001
 * @tc.desc: Test function of UtimesSync() interface for fail.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(UtimesMockTest, UtimesSync_0001, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "UtimesMockTest-begin UtimesSync_0001";
    ...
    EXPECT_CALL(*libnMock_, ToDouble()).WillOnce(testing::Return(move(mtimeRes)));
    EXPECT_CALL(*uvMock_, uv_fs_req_cleanup(testing::_)).Times(2);
    EXPECT_CALL(*uvMock_, uv_fs_stat(testing::_, testing::_, testing::_, testing::_)).WillOnce(testing::Return(1));
    EXPECT_CALL(*uvMock_, uv_fs_utime(testing::_, testing::_, testing::_, testing::_, testing::_, testing::_))
    ...
    GTEST_LOG_(INFO) << "UtimesMockTest-end UtimesSync_0001";
}
