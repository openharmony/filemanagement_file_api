 ...
 * @tc.desc: Test function of WatcherEntityTest::CloseNotifyFdLocked interface for SUCCESS when reading_ is true with concurrent threads.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of WatcherEntityTest::CloseNotifyFdLocked interface for SUCCESS when reading_ is true and run_ is false with concurrent threads.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of WatcherEntityTest::CloseNotifyFdLocked interface for SUCCESS after InitNotify with concurrent threads.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of WatcherEntityTest::CloseNotifyFdLocked interface for FAILURE during concurrent GetNotifyEvent and close.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
