...
{
    GTEST_LOG_(INFO) << "NClassTest-begin XattrCoreTest_DoSetXattr_001";

    std::shared_ptr<SystemMock> sys = std::make_shared<SystemMock>();
    System::ins = sys;
    ...
    GTEST_LOG_(INFO) << "NClassTest-end XattrCoreTest_DoSetXattr_001";
}
...
{
    GTEST_LOG_(INFO) << "NClassTest-begin XattrCoreTest_DoSetXattr_002";

    string path = tempFilePath.string();
    std::string key(4097, 'a');
    ...
    GTEST_LOG_(INFO) << "NClassTest-end XattrCoreTest_DoSetXattr_002";
}

/**
 * @tc.name: XattrCoreTest_DoSetXattr_003
 * @tc.desc: Test function of XattrCore::DoSetXattr interface for FAILED.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(XattrCoreTest, XattrCoreTest_DoSetXattr_003, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "NClassTest-begin XattrCoreTest_DoSetXattr_003";

    string path = tempFilePath.string();
    std::string key = "test_key";
    std::string value(4097, 'a');
    ...
    GTEST_LOG_(INFO) << "NClassTest-end XattrCoreTest_DoSetXattr_003";
}
...
{
    GTEST_LOG_(INFO) << "NClassTest-begin XattrCoreTest_DoGetXattr_001";
    ...
    GTEST_LOG_(INFO) << "NClassTest-end XattrCoreTest_DoGetXattr_001";
}
