 ...
 * @tc.desc: Test function of ReaderIterator() interface for SUCCESS when opening an existing file.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of ReaderIterator() interface for FAILURE when file does not exist.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(RustTest, RustTest_ReaderIterator_0002, testing::ext::TestSize.Level1)
{
    ...
    char filePath[] = "/data/test/non_existent.txt";
    void *iter = ReaderIterator(filePath);
    ASSERT_TRUE(errno == 2);
    EXPECT_TRUE(iter == nullptr);
 ...
 * @tc.desc: Test function of ReaderIterator() interface for FAILURE when path is nullptr.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of NextLine() interface for SUCCESS when reading the first line.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of NextLine() interface for FAILURE when iterator is nullptr.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for SUCCESS when seeking from END.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for SUCCESS when seeking from END then CURRENT.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for SUCCESS when seeking from START.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for FAILURE when offset is negative from START.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of Lseek() interface for SUCCESS when seeking from START then CURRENT.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for SUCCESS when seeking from END with positive offset.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Lseek() interface for FAILURE when fd is closed.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for SUCCESS when creating a single directory.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for SUCCESS when creating multiple directories.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for FAILURE when parent directory does not exist.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for SUCCESS when directory already exists.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for FAILURE when path is empty.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of Mkdirs() interface for FAILURE when path already exists as a file.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of GetParent() interface for SUCCESS when fd is valid.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 0
 */
 ...
 * @tc.desc: Test function of GetParent() interface for FAILURE when fd is invalid.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of StrFree() interface for SUCCESS when freeing a valid str.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
 ...
 * @tc.desc: Test function of StrFree() interface for SUCCESS when str is nullptr.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
...
/**
 * @tc.name: RustTest_CutFileName_0001
 * @tc.desc: Test function of CutFileName() interface for SUCCESS when cutting file name.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(RustTest, RustTest_CutFileName_0001, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RustTest-begin RustTest_CutFileName_0001";
    string myStr = "<?,你好，世界！hello, world! ?XML, 你好，世界！";

    Str *str1 = CutFileName(myStr.c_str(), 2);
    GTEST_LOG_(INFO) << "RustTest_CutFileName_0001 str1" << str1->str;
    GTEST_LOG_(INFO) << "RustTest_CutFileName_0001 str1" << str1->len;
    EXPECT_TRUE(string(str1->str).compare("<?,你好，世界！hello, world! ?XML, 你好，世") == 0);
    StrFree(str1);
    Str *str2 = CutFileName(myStr.c_str(), 10);
    GTEST_LOG_(INFO) << "RustTest_CutFileName_0001 str2" << str2->str;
    GTEST_LOG_(INFO) << "RustTest_CutFileName_0001 str2" << str2->len;
    EXPECT_TRUE(string(str2->str).compare("<?,你好，世界！hello, world! ?X") == 0);
    StrFree(str2);

    GTEST_LOG_(INFO) << "RustTest-end RustTest_CutFileName_0001";
}
