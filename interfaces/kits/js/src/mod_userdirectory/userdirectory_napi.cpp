 ...
 ***********************************************/
napi_value UserDirectoryExport(napi_env env, napi_value exports)
{
    static napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("getUserDocumentsDir", GetUserDocumentsDir),
...
static napi_module _module = {.nm_version = 1,
                              .nm_flags = 0,
                              .nm_filename = nullptr,
                              .nm_register_func = UserDirectoryExport,
                              .nm_modname = "file.userdirectory",
                              .nm_priv = ((void *)0),
                              .reserved = {0}};
