...
static ani_status BindRafFileMethods(ani_env *env)
{
    ...
    std::array methods = {
        ani_native_function { "setFilePointer0", nullptr,
            reinterpret_cast<void *>(RandomAccessFileAni::SetFilePointer) },
...
static ani_status BindStaticMethods(ani_env *env)
{
    ...
    std::array methods = {
        ...
        ani_native_function { "createRandomAccessFileSync", nullptr, reinterpret_cast<void *>(
            CreateRandomAccessFileAni::CreateRandomAccessFileSync) },
