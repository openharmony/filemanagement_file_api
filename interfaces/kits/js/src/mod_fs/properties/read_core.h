...
#ifndef INTERFACES_KITS_JS_SRC_MOD_FS_PROPERTIES_READ_CORE_H
#define INTERFACES_KITS_JS_SRC_MOD_FS_PROPERTIES_READ_CORE_H
...
#endif // INTERFACES_KITS_JS_SRC_MOD_FS_PROPERTIES_READ_CORE_H