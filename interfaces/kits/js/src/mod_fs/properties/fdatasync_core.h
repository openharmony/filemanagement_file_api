...
#ifndef INTERFACES_KITS_JS_SRC_MOD_FS_PROPERTIES_FDATASYNC_CORE_H
#define INTERFACES_KITS_JS_SRC_MOD_FS_PROPERTIES_FDATASYNC_CORE_H

#include "filemgmt_libfs.h"
#include "fs_utils.h"

namespace OHOS::FileManagement::ModuleFileIO {
class FDataSyncCore final {
public:
