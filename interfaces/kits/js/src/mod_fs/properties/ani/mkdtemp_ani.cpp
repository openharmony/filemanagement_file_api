...
ani_string MkdtempAni::MkdtempSync(ani_env *env, [[maybe_unused]] ani_class clazz, ani_string prefix)
{
    auto [succPath, prefixPath] = TypeConverter::ToUTF8String(env, prefix);
    if (!succPath) {
        HILOGE("Invalid path");
