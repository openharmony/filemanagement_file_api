...
const std::string PROCEDURE_STREAM_WRITE_NAME = "fs.Stream.write";
const std::string PROCEDURE_STREAM_READ_NAME = "fs.Stream.read";
const std::string PROCEDURE_STREAM_CLOSE_NAME = "fs.Stream.close";
const std::string PROCEDURE_STREAM_FLUSH_NAME = "fs.Stream.flush";
