...
napi_value FileNExporter::Mkdir(napi_env env, napi_callback_info info)
{
    ...
    unique_ptr<char[]> uri;
    tie(succ, uri, ignore) = NVal(env, funcArg[NARG_POS::FIRST]).GetProp("uri").ToUTF8StringPath();
...
napi_value FileNExporter::Copy(napi_env env, napi_callback_info info)
{
    ...
    tie(succ, srcUri, ignore) = NVal(env, funcArg[NARG_POS::FIRST]).GetProp("srcUri").ToUTF8StringPath();
    tie(succ, dstUri, ignore) = NVal(env, funcArg[NARG_POS::FIRST]).GetProp("dstUri").ToUTF8StringPath();
