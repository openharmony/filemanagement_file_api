...
class PropNExporterV9 final : public NExporter {
public:
    inline static const std::string className_ = "__properitiesV9__";
    ...
    PropNExporterV9(napi_env env, napi_value exports);
    ~PropNExporterV9() override;
};
} // namespace ModuleFileIO
} // namespace DistributedFS
} // namespace OHOS
