...
static inline std::unordered_map<int, std::pair<int32_t, std::string>> errCodeTable {
    ...
    { STORAGE_SERVICE_SYS_CAP_TAG + E_EMPTY_DISC, { STORAGE_SERVICE_SYS_CAP_TAG + E_EMPTY_DISC, "Empty disc" } },
    { STORAGE_SERVICE_SYS_CAP_TAG + E_ISO_WRITE_FAILED, { STORAGE_SERVICE_SYS_CAP_TAG + E_ISO_WRITE_FAILED,
        "Failed to write the ISO file" } },
    { STORAGE_SERVICE_SYS_CAP_TAG + E_ERASE_FAILED, { STORAGE_SERVICE_SYS_CAP_TAG + E_ERASE_FAILED,
        "Erase operation failed" } },
    { STORAGE_SERVICE_SYS_CAP_TAG + E_EJECT_FAILED, { STORAGE_SERVICE_SYS_CAP_TAG + E_EJECT_FAILED,
        "Eject operation failed" } },
    { STORAGE_SERVICE_SYS_CAP_TAG + E_BURN_FAILED, { STORAGE_SERVICE_SYS_CAP_TAG + E_BURN_FAILED,
