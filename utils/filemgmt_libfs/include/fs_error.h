...
#ifndef FILEMANAGEMENT_FS_ERROR_H
...
static inline std::unordered_map<int, std::pair<int32_t, std::string>> errCodeTable{
    ...
    {FILEIO_SYS_CAP_TAG + E_DEADLK,
     {FILEIO_SYS_CAP_TAG + E_DEADLK, "Resource deadlock would occur"}},
    {FILEIO_SYS_CAP_TAG + E_NAMETOOLONG,
     {FILEIO_SYS_CAP_TAG + E_NAMETOOLONG, "File name too long"}},
    ...
    {FILEIO_SYS_CAP_TAG + E_LOOP,
     {FILEIO_SYS_CAP_TAG + E_LOOP, "Too many symbolic links encountered"}},
    {FILEIO_SYS_CAP_TAG + E_WOULDBLOCK,
     {FILEIO_SYS_CAP_TAG + E_WOULDBLOCK, "Operation would block"}},
    ...
    {FILEIO_SYS_CAP_TAG + E_OVERFLOW,
     {FILEIO_SYS_CAP_TAG + E_OVERFLOW, "Value too large for defined data type"}},
    ...
    {FILEIO_SYS_CAP_TAG + E_NETUNREACH,
     {FILEIO_SYS_CAP_TAG + E_NETUNREACH, "Network is unreachable"}},
    {FILEIO_SYS_CAP_TAG + E_CONNECTION_FAIL,
     {FILEIO_SYS_CAP_TAG + E_CONNECTION_FAIL, "Connection failed"}},
    ...
    {USER_FILE_MANAGER_SYS_CAP_TAG + E_URIM,
     {USER_FILE_MANAGER_SYS_CAP_TAG + E_URIM, "Invalid uri"}},
    ...
    {USER_FILE_MANAGER_SYS_CAP_TAG + E_ROOT_DIR,
     {USER_FILE_MANAGER_SYS_CAP_TAG + E_ROOT_DIR, "Invalid root dir"}},
    ...
    {USER_FILE_MANAGER_SYS_CAP_TAG + E_FILE_KEY,
     {USER_FILE_MANAGER_SYS_CAP_TAG + E_FILE_KEY, "Member not exist"}},
    {USER_FILE_MANAGER_SYS_CAP_TAG + E_INPUT,
     {USER_FILE_MANAGER_SYS_CAP_TAG + E_INPUT, "Wrong input parameter"}},
    ...
    {STORAGE_SERVICE_SYS_CAP_TAG + E_MOUNT,
     {STORAGE_SERVICE_SYS_CAP_TAG + E_MOUNT, "Failed to mount"}},
    {STORAGE_SERVICE_SYS_CAP_TAG + E_UNMOUNT,
     {STORAGE_SERVICE_SYS_CAP_TAG + E_UNMOUNT, "Failed to unmount"}},
    ...
    {STORAGE_SERVICE_SYS_CAP_TAG + E_NOOBJECT,
     {STORAGE_SERVICE_SYS_CAP_TAG + E_NOOBJECT, "No such object"}},
    ...
    {USER_FILE_SERVICE_SYS_CAP_TAG + E_URIS,
     {USER_FILE_SERVICE_SYS_CAP_TAG + E_URIS, "Invalid uri"}},
    ...
    {USER_FILE_SERVICE_SYS_CAP_TAG + E_NOTIFY,
     {USER_FILE_SERVICE_SYS_CAP_TAG + E_NOTIFY, "Fail to notify agent"}},
    ...
    {USER_FILE_SERVICE_SYS_CAP_TAG + E_COUNT,
     {USER_FILE_SERVICE_SYS_CAP_TAG + E_COUNT, "Too many records"}},
...
#endif // FILEMANAGEMENT_FS_ERROR_H